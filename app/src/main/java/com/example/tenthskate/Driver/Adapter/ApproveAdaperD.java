...
public class ApproveAdaperD extends RecyclerView.Adapter<ApproveAdaperD.ProductsViewHolder> implements View.OnClickListener{
    private Context mContext;
    private List<Order> mUploads;
    View v;
    DatabaseReference order = FirebaseDatabase.getInstance().getReference().child("Orders");
    public ApproveAdaperD(Context context, List<Order> orders)
    {
        mContext=context;
        mUploads=orders;
    }
    ...
    public ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        v= LayoutInflater.from(mContext).inflate(R.layout.deliverdriver, viewGroup,false);
