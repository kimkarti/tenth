...
import com.example.tenthskate.Finance.Activity.CheckOrderDetails;
...
public class deliverdAdapter extends RecyclerView.Adapter<deliverdAdapter.ProductsViewHolder> implements View.OnClickListener{
    private Context mContext;
    private List<Order> mUploads;
    View v;
    DatabaseReference order = FirebaseDatabase.getInstance().getReference().child("Orders");
    public deliverdAdapter(Context context, List<Order> orders)
    {
        mContext=context;
        mUploads=orders;
    }
