package com.example.tenthskate.stockinventor.Class;
...
public class apload {
    ...
    public apload(String productName,String productDescription,  String productCategory, String productPrice,  String productID, String searchableName) {
