...
public class AddProductActivity extends AppCompatActivity {
    ...
    private EditText productName, productCode, productDescription, productPrice, productQuantity,qnty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stock_activity_add_product);
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    ...
                    qnty.setError("Product quantity required");
                }
                else
                uploadProduct();
            }
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    //added
                                    mDatabaseCategoryRef.child(category).child(uploadID).child("quantity").setValue(qnty.getText().toString().trim());
                                    mDatabaseProductsRef.child(uploadID).child("quantity").setValue(qnty.getText().toString().trim());

                                    mDatabaseCategoryRef.child(category).child(uploadID).child("uploadId").setValue(uploadID);
                                    mDatabaseProductsRef.child(uploadID).child("uploadId").setValue(uploadID);
