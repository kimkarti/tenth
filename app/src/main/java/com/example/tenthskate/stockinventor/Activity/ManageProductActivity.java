...
public class ManageProductActivity extends AppCompatActivity {
    ...
    private EditText manageProductName, quenty,manageProductCode, manageProductDescription, manageProductPrice, manageProductCuttedPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stock_activity_manage_product);
        ...
        quenty= (EditText) findViewById(R.id.quenty);
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                quenty.setText(snapshot.child("quantity").getValue().toString());
    ...
    private void updateInformation() {
        ...
        if (quenty.getText().toString().isEmpty()){
            manageProductCuttedPrice.setError("Product pckg required");
        }
        else {
            ...
            categoryRef.child(retProductCategory).child(productID).child("quantity").setValue(quenty.getText().toString());
            ...
            productsRef.child(productID).child("quantity").setValue(quenty.getText().toString());
