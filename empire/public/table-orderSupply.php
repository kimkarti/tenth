...
?>
	<?php 
		...
		if (empty($keyword)) {
			$sql_query = "SELECT * FROM tbl_supply where status='1' ORDER BY id DESC LIMIT ?, ?";
		} else {
...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<div class="section"> 
			...
			<?php $function->doPages($offset, 'manage-supply.php', '', $total_records, $keyword); ?>
			</form>
		</div>
							...
							<tbody>
								<tr>
									...
									<td>
									    ...
									    <a href="manage-supply.php?id=<?php echo $data['id'];?>" onclick="return confirm('Are you sure want to permanently delete this supply?')" >
