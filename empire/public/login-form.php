<?php
    ...
    //session_start();
    //tbl_purchase_code
    $setting_qry    = "SELECT * FROM driver ORDER BY id DESC LIMIT 1";
        ...
        <div class="login-card">
            <form method="POST">  
                <div class="pmd-card-title card-header-border text-center">
                    <div class="loginlogo">
                        <img src="assets/images/quadskate.jpg" alt="Logo">
                    </div>
                    <!-- <div class="lead">FLOOR DECOR KENYA</div> -->
                </div>
                ...
                <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
                  ...
                  Forgot Password? <a href="public/index11.html">Reset now</a>
                    ...
                    <br>
                    <br>
                    <span class="pmd-card-subtitle-text"> KIMANI DAVE &copy; <span class="auto-update-year">2023</span>. All Rights Reserved.</span>
            <h3 class="pmd-card-subtitle-text"><a href="https://codecanyon.net/item/ecommerce-online-shop-app/10442576" target="_blank">Version 1.0.0</a></h3>
