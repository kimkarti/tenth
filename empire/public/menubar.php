...
<title>ANDROID E-COMMERCE</title>
...
<link rel="shortcut icon" type="image/x-icon" href="assets/images/quadskate.jpg">
...
<nav class="navbar navbar-inverse navbar-fixed-top pmd-navbar pmd-z-depth">
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			<a href="javascript:void(0);" data-target="basicSidebar" data-placement="left" data-position="slidepush" is-open="true" is-open-width="1200" class="btn btn-sm pmd-btn-fab pmd-btn-flat pmd-ripple-effect pull-left margin-r8 pmd-sidebar-toggle"><i class="material-icons md-dark">menu</i></a>	
...
<aside id="basicSidebar" class="pmd-sidebar sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
	<ul class="nav pmd-sidebar-nav">
		...
		<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				...
				<li><a href="customers.php">Pending</a></li>
				 ...
				 <li><a href="Rpending.php">Rejected</a></li>
		...
		<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				...
				<li><a href="drivers.php">Pending</a></li>
					<li><a href="driverRejected.php">Rejected</a></li>
				<li style="display:none;"><a href="edit-category.php"></a></li>
			</ul>
		</li>
        	<li class="dropdown pmd-dropdown"> 
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">	
				<i class="material-icons media-left pmd-sm">dns</i> 
				<span class="media-body">Transactions</span>
				<div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
			</a> 
			<ul class="dropdown-menu">
				
				<li><a href="manage-orderPending.php">See Transactions</a></li>
				<li style="display:none;"><a href="edit-category.php"></a></li>
			</ul>
		</li>
			<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				...
				<!-- <li><a href="customerR.php">Cancelled</a></li> -->
				<li><a href="manage-shipped.php">InShippement Orders</a></li>
		...
		<!-- <li> 
			<a class="pmd-ripple-effect" href="public/data-inventory.html">	
				<i class="media-left media-middle material-icons">content_paste</i>
