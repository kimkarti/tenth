...
?>
	<?php 
		...
		if (empty($keyword)) {
			$sql_query = "SELECT * FROM tbl_customer where status=0 ORDER BY id DESC LIMIT ?, ?";
		} else {
			$sql_query = "SELECT * FROM tbl_customer WHERE name LIKE ? ORDER BY id DESC LIMIT ?, ?";
		}
...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<div class="section"> 
							...
							<tbody>
								<tr>
									...
									<td>
									    ...
									    <a href="customers.php?id=<?php echo $data['id'];?>" onclick="return confirm('Are you sure want to permanently delete this customer?')" >
			...
			<?php $function->doPages($offset, 'customers.php', '', $total_records, $keyword); ?>
			</form>
		</div>
