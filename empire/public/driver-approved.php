<?php 
    ...
    if (isset($_GET['id'])) {
        ...
        Delete('driver','id='.$_GET['id'].'');

        header("location: driverApproved.php");
        exit;
...
?>
	<?php 
		...
		if (empty($keyword)) {
			$sql_query = "SELECT * FROM driver ORDER BY id DESC";
		} else {
			$sql_query = "SELECT * FROM driver WHERE fname LIKE ? ORDER BY id DESC";
		}
		...
		if (empty($keyword)) {
			$sql_query = "SELECT * FROM driver WHERE status=1 ORDER BY id DESC LIMIT ?, ?";
		} else {
			$sql_query = "SELECT * FROM driver WHERE name LIKE ? ORDER BY id DESC LIMIT ?, ?";
		}
...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<div class="section"> 
			...
			<?php $function->doPages($offset, 'customer-approve.php', '', $total_records, $keyword); ?>
			</form>
		</div>
		...
		<div class="section"> 
			...
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="lead">Approved Driver</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 pull-right">
							<div class="form-group pmd-textfield">
								<input type="text" name="keyword" class="form-control" placeholder="Search...">
			...
			<?php $function->doPages($offset, 'driverApproved.php', '', $total_records, $keyword); ?>
			</form>
		</div>
