<?php 
    ...
    if (isset($_GET['id'])) {
        ...
        header("location: manage-delOrders.php");
        exit;
...
?>
	<?php 
		...
		if (empty($keyword)) {
			$sql_query = "SELECT * FROM tbl_order where status='4' ORDER BY id DESC LIMIT ?, ?";
		} else {
...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<div class="section"> 
			...
			<?php $function->doPages($offset, 'manage-delOrders.php', '', $total_records, $keyword); ?>
			</form>
		</div>
						...
						<table cellspacing="0" cellpadding="0" class="table pmd-table table-hover" id="table-propeller">
							...
							<tbody>
								<tr>
									...
									<td>
									    <a href="order-deldetail.php?id=<?php echo $data['id'];?>">
									        <i class="material-icons">open_in_new</i>
									    </a>
									                        
									    <a href="manage-delOrders.php?id=<?php echo $data['id'];?>" onclick="return confirm('Are you sure want to permanently delete this order?')" >
